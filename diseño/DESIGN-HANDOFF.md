# 29711035-6d34-4c6a-ae55-8bb3bb87f2f0 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `ecommerce-celular-auricular.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `ecommerce-celular-auricular.html`
...
- A single self-contained `ecommerce-celular-auricular.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `ecommerce-celular-auricular.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `ecommerce-celular-auricular.html`
...
1. Inspect `ecommerce-celular-auricular.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
