...
");
        ...
        private static async Task SeedOrdersAsync(ApplicationDbContext context, ILogger logger)
        {
            try
            {
                ...
                var orders = new List<Order>
                {
                    ...
                    new()
                    {
                        OrderNumber = "NOD-9398",
                        TransactionToken = "TRX-9398-42A988F0",
                        CustomerName = "Julieta Rossi",
                        DocumentId = "43019284",
                        Email = "julieta.rossi@example.com",
                        Phone = "+54 9 261 488-2910",
                        Address = "San Martín 1140",
                        City = "Mendoza Capital",
                        Province = "Mendoza",
                        PostalCode = "5500",
                        Notes = "Esperando comprobante de pago.",
                        Status = "Pendiente",
                ...
                logger.LogInformation("5 pedidos demo de NODO sembrados correctamente.");
            }
            catch (Exception ex)
            {
        ...
        private static async Task SeedProductsAsync(ApplicationDbContext context, ILogger logger)
        {
            ...
            {
                new() { Name = "iPhone 15 Pro", Brand = "Apple", Spec = "128 GB · Titanio · A17 Pro · 6.1\"", Price = 1299000m, WasPrice = 1399000m, Badge = "Más vendido", Stock = 15, IsOffer = true, Category = "celular", Description = "El equilibrio perfecto entre potencia y tamaño. Cámara 48 MP, grabación ProRes y batería para todo el día." },
                new() { Name = "Galaxy S24 Ultra", Brand = "Samsung", Spec = "256 GB · Snapdragon 8 Gen 3 · S-Pen", Price = 1399000m, WasPrice = 1599000m, Badge = "-12%", Stock = 12, IsOffer = true, Category = "celular", Description = "Pantalla 6.8\" 120 Hz, zoom 100× y la mejor batería de la serie S." },
                new() { Name = "Pixel 8", Brand = "Google", Spec = "128 GB · Tensor G3 · Cámara IA", Price = 899000m, WasPrice = null, Badge = null, Stock = 8, IsOffer = false, Category = "celular", Description = "Android puro, fotos nocturnas increíbles y 7 años de actualizaciones." },
                new() { Name = "iPhone 15", Brand = "Apple", Spec = "128 GB · A16 · 6.1\" · USB-C", Price = 999000m, WasPrice = null, Badge = null, Stock = 18, IsOffer = false, Category = "celular", Description = "El iPhone esencial, ahora con USB-C y Dynamic Island." },
                new() { Name = "Galaxy A54", Brand = "Samsung", Spec = "128 GB · Exynos 1380 · IP67", Price = 429000m, WasPrice = 499000m, Badge = "Cuotas", Stock = 22, IsOffer = true, Category = "celular", Description = "Gama media sin recortes: agua, 120 Hz y gran autonomía." },
                new() { Name = "Xiaomi 14", Brand = "Xiaomi", Spec = "256 GB · Leica · 90W", Price = 749000m, WasPrice = null, Badge = "Nuevo", Stock = 9, IsOffer = false, Category = "celular", Description = "Colaboración Leica, carga en 31 min y diseño compacto." },
                new() { Name = "WH-1000XM5", Brand = "Sony", Spec = "Over-ear · ANC líder · 30 h", Price = 389000m, WasPrice = 459000m, Badge = "-15%", Stock = 14, IsOffer = true, Category = "auricular", Description = "Cancelación de ruido referente, llamadas cristalinas y multipoint." },
                new() { Name = "AirPods Pro (2ª gen)", Brand = "Apple", Spec = "In-ear · H2 · ANC · MagSafe", Price = 329000m, WasPrice = null, Badge = null, Stock = 25, IsOffer = false, Category = "auricular", Description = "Audio espacial, ANC adaptativo y estuche con precisión." },
                new() { Name = "QuietComfort Ultra", Brand = "Bose", Spec = "Over-ear · Audio espacial · 24 h", Price = 419000m, WasPrice = 479000m, Badge = "-12%", Stock = 6, IsOffer = true, Category = "auricular", Description = "Confort legendario y aislamiento total, ahora con audio espacial." },
                new() { Name = "Momentum 4", Brand = "Sennheiser", Spec = "Over-ear · 60 h · aptX", Price = 279000m, WasPrice = null, Badge = "60 h", Stock = 7, IsOffer = false, Category = "auricular", Description = "60 h de batería real, sonido audiophile y ecualizador integrado." },
                new() { Name = "Nothing Phone (2)", Brand = "Nothing", Spec = "128 GB · Glyph · 6.7\"", Price = 599000m, WasPrice = null, Badge = null, Stock = 0, IsOffer = false, Category = "celular", Description = "Diseño transparente y Nothing OS ultra fluido." },
                new() { Name = "JBL Live 660NC", Brand = "JBL", Spec = "Over-ear · 50 h · BT 5.3", Price = 119000m, WasPrice = 149000m, Badge = "Oferta", Stock = 16, IsOffer = true, Category = "auricular", Description = "Graves potentes, 50 h de autonomía y app dedicada con EQ." },
                new() { Name = "Motorola Edge 40", Brand = "Motorola", Spec = "256 GB · Dimensity 8020 · IP68", Price = 479000m, WasPrice = null, Badge = null, Stock = 11, IsOffer = false, Category = "celular", Description = "Curvo, liviano, resistente al agua y con carga TurboPower." },
                new() { Name = "WF-1000XM5", Brand = "Sony", Spec = "In-ear · ANC · 8 h + 16 h", Price = 299000m, WasPrice = null, Badge = null, Stock = 10, IsOffer = false, Category = "auricular", Description = "Los in-ear con cancelación activa más premiados del mercado." },
                new() { Name = "Galaxy Z Flip5", Brand = "Samsung", Spec = "256 GB · Plegable · 6.7\"", Price = 1099000m, WasPrice = 1299000m, Badge = "Plegable", Stock = 5, IsOffer = true, Category = "celular", Description = "Se pliega a la mitad, cabe en cualquier bolsillo y tiene pantalla externa Flex." },
                new() { Name = "AirPods Max", Brand = "Apple", Spec = "Over-ear · H1 · 20 h", Price = 599000m, WasPrice = null, Badge = null, Stock = 4, IsOffer = false, Category = "auricular", Description = "Aluminio anodizado, audio computacional y modo ambiente inigualable." }
            };

            await context.Products.AddRangeAsync(products);
            await context.SaveChangesAsync();
            logger.LogInformation("16 productos iniciales NODO sembrados correctamente.");
        }
